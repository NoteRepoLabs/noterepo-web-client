                    ...
                    <div className="py-4">
                        ...
                        <ol className="list-decimal mt-2">
                            <li className="ml-4  dark:text-neutral-300 text-neutral-500 mb-1">
                                ...
                                <p>
                                    This is usually an issue with the browser
                                    cache. If a full refresh doesn&apos;t do the
                                    trick, try clearing your cache and cookies.
                                </p>
                            </li>
                            <li className="ml-4 dark:text-neutral-300 text-neutral-500 mb-1">
                                <h3 className="font-bold dark:text-neutral-200 text-neutral-800">
                                ...
                                <p>
                                    ...
                                    repo or file on one device and trying to
                                    access them on another. We automatically
                                    sync out-of-date repos every 5 minutes to
                                    improve performance.
                                </p>
                            </li>
                            <li className="ml-4 dark:text-neutral-300 text-neutral-500 mb-1">
                                ...
                                <p>
                                    ...
                                    they&apos;re limited to only word,
                                    powerpoint, pdf and image files.
                                </p>
                            </li>
                            <li className="ml-4 dark:text-neutral-300 text-neutral-500 mb-1">
                                <h3 className="font-bold dark:text-neutral-200 text-neutral-800">
                                ...
                                <p>
                                    We limit the file size of any repo to 10MB
                                    since most study materials don&apos;t exceed
                                    this threshold...and our BLOB store
                                    won&apos;t allow it either for the free
                                    plan. :)
                                </p>
                            </li>
                            <li className="ml-4 dark:text-neutral-300 text-neutral-500 mb-1">
                                ...
                                <p>
                                    ...
                                    NoteRepo, by default the server encrypts
                                    some of your user and file information and
                                    no other entity knows about what you upload
                                    unless you compromise your account password.
                                    Never share it with anyone by the way.
                                </p>
                            </li>
                            <li className="ml-4 dark:text-neutral-300 text-neutral-500 mb-1">
                                <h3 className="font-bold dark:text-neutral-200 text-neutral-800">
                                ...
                                <p>
                                    It&apos;s sad to see you want to go, but you
                                    can delete your account and everything else
                ...
                <BottomBorderContainer>
                    <div className="py-4">
                        ...
                        <p className="dark:text-neutral-300 text-neutral-500 mt-2">
                            You can also make a feature request by opening an
                ...
                <BottomBorderContainer>
                    <div className="py-4">
                        ...
                        <p className="dark:text-neutral-300 text-neutral-500">
                            ...
                            Computer Science students who&apos;ve worked
                            tirelessly for months to bring their idea into
                            fruition, made completely free and open source for
                            everyone to use!
                        </p>
                        ...
                        <p className="mt-2 dark:text-neutral-300 text-neutral-500">
                            Huge thanks to everyone that participated in the
                            beta release testing for their immensely valuable
                            feedback.
                        </p>
                    </div>
                </BottomBorderContainer>
