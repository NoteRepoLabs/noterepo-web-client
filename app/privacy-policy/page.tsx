...
/**
 * Responsible for presenting NoteRepo's privacy policy page.
 * @returns a privacy policy page
 */
export default function Page() {
    return (
        <Container>
            <section className="max-w-screen-md">
                <h1 className="text-center text-4xl mt-8 mb-4 font-bold">Privacy Policy</h1>
                <p className="dark:text-neutral-300 text-neutral-500 font-bold text-center mb-8">Last updated: September 05, 2024</p>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h2 className="text-2xl my-2">Interpretation and Definitions</h2>
                <h3 className="mx-4 my-2">Interpretation</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h3 className="mx-4 my-2">Definitions</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >For the purposes of this Privacy Policy:</p>
                <ul>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                        <p className="dark:text-neutral-300 mx-8 my-2" >
                    ...
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                        <p className="dark:text-neutral-300 mx-8 my-2" >
                            <strong>Website</strong> refers to NoteRepo,
                            accessible from{' '}
                            <a
                                href="https://noterepo.com.ng"
                                rel="external nofollow noopener"
                                target="_blank"
                            >
                                https://noterepo.com.ng
                            </a>
                        </p>
                    </li>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                ...
                <h3 className="mx-4 my-2">Types of Data Collected</h3>
                <h4>Personal Data</h4>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <ul>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                        <p className="dark:text-neutral-300 mx-8 my-2" >Email address</p>
                    </li>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                        <p className="dark:text-neutral-300 mx-8 my-2" >Usage Data</p>
                    </li>
                </ul>
                <h4>Usage Data</h4>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <ul>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                        ...
                        <p className="dark:text-neutral-300 mx-8 my-2" >Type: Session Cookies</p>
                        <p className="dark:text-neutral-300 mx-8 my-2" >Administered by: Us</p>
                        <p className="dark:text-neutral-300 mx-8 my-2" >
                    ...
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                        ...
                        <p className="dark:text-neutral-300 mx-8 my-2" >Type: Persistent Cookies</p>
                        <p className="dark:text-neutral-300 mx-8 my-2" >Administered by: Us</p>
                        <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h3 className="mx-4 my-2">Use of Your Personal Data</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h3 className="mx-4 my-2">Retention of Your Personal Data</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h3 className="mx-4 my-2">Transfer of Your Personal Data</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h3 className="mx-4 my-2">Delete Your Personal Data</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <h3 className="mx-4 my-2">Disclosure of Your Personal Data</h3>
                ...
                <ul>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">Comply with a legal obligation</li>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">
                    ...
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">Protect against legal liability</li>
                </ul>
                <h3 className="mx-4 my-2">Security of Your Personal Data</h3>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <p className="dark:text-neutral-300 mx-8 my-2" >
                    ...
                    consent from a parent, We may require Your paren&apos;s
                    consent before We collect and use that information.
                </p>
                <h2 className="text-2xl my-2">Links to Other Websites</h2>
                <p className="dark:text-neutral-300 mx-8 my-2" >
                ...
                <ul>
                    <li className="mx-8 list-disc my-2 dark:text-neutral-300 text-neutral-500">By email: noterepo.engineering@gmail.com</li>
                </ul>
            </section>
        </Container>
    );
