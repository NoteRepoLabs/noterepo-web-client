    ...
    return (
       <section className="max-w-2xl md:my-8 mx-3 md:mx-auto flex flex-col justify-center items-center min-h-screen">
          ...
          <p className="text-center font-bold text-base text-neutral-500 dark:text-neutral-300 mb-12">
             A link has been sent to reset your password. Please check your inbox.
          </p>
          <p>
            <span className="font-semibold text-neutral-500 dark:text-neutral-300">Didn&apos;t get an email? </span>
            <Link
               underlined={true}
               href=""
               text="Resend Link"
